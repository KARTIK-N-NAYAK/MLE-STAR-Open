...
class SequentialAgent:
    ...
    def run(self, state: State) -> None:
        print(f"Running sequential agent: {self.name}...")
        ctx = CallbackContext(agent_name=self.name, state=state)
...
class ParallelAgent:
    ...
    def run(self, state: State) -> None:
        print(f"Running parallel agent: {self.name}...")
...
class LoopAgent:
    ...
    def run(self, state: State) -> None:
        print(f"Running loop agent: {self.name} for max {self.max_iterations} iterations...")
        ctx = CallbackContext(agent_name=self.name, state=state)
